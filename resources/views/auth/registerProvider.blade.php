...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-dark text-light">{{ __('User Information') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('createProvider') }}">
                        @csrf
                ...
                <div class='card'>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="street" value="{{ old('address') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="state" value="{{ old('city') }}" required autocomplete="name" autofocus>
            ...
            <div class='card'>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="p_no" value="{{ old('address') }}" required autocomplete="name" autofocus>
            ...
            <div class='card'>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('SSM') }}</label>

                        <div class="col-md-6">
                            <input id="name" type="file" class="form-control" name="ssm">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="file" class="form-control" name="ic">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="file" class="form-control" name="swa">
                        </div>
                    </div>
